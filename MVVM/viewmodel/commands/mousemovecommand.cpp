...
void mouseMoveCommand::SetParameter(const std::shared_ptr<ParametersBase>& param)
{
    mouseOnRow = 0;
    mouseOnCol = 0;
    std::string coor = std::static_pointer_cast<StringParameters,ParametersBase>(param)->getvalue();
    int i = 0;
    while (i < coor.size()){
